...
const TELEGRAM_IMG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663508251297/DLgAeusBc3GPPZNVGu2d5R/telegram-bot-o7kKjwjASCQKXZ7QPui2oE.webp";
...
const botCommands = [
  ...
  {
    cmd: "/price [coin]",
    desc: "Get current price for a specific coin (e.g., /price btc)",
  },
  {
    cmd: "/alert [coin] [price]",
    desc: "Set price alert (e.g., /alert btc 90000)",
  },
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-400 text-sm -mt-4">
        Automated signal delivery, sentiment analysis, and subscriber management
      </p>
          ...
          >
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="text-center">
                <div className="font-mono text-4xl font-bold text-[#00ff88]">
                  62%
                </div>
            ...
            <div className="space-y-2">
              {botCommands.map(cmd => (
                ...
                >
                  ...
                  >
                    <code className="text-[#00ff88] text-xs font-mono bg-[#00ff88]/10 px-1.5 py-0.5 rounded">
                      {cmd.cmd}
                    </code>
          ...
          >
            ...
            <div className="space-y-3 text-sm text-gray-400">
              <div className="flex gap-3">
                <span className="text-[#00ff88] font-mono text-xs shrink-0">
                  01
                </span>
                <p>
                  Create a bot via{" "}
              ...
              <div className="flex gap-3">
                ...
                <p>
                  Set webhook URL to:{" "}
                  <code className="text-[#00d4ff] text-xs bg-[#00d4ff]/10 px-1 rounded">
                    your-domain.com/api/telegram/webhook
                  </code>
                </p>
              </div>
              <div className="flex gap-3">
            ...
            <div className="mt-4 p-3 rounded-lg bg-[#ffb800]/5 border border-[#ffb800]/20">
              <p className="text-[#ffb800] text-xs">
                <strong>Pro Tip:</strong> Use /alert to set price notifications.
                The bot will message you when your target price is hit.
              </p>
            </div>
          </motion.div>
