...
const DASHBOARD_BG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663508251297/DLgAeusBc3GPPZNVGu2d5R/dashboard-bg-nj6u97zo72UK4oyzhJEJ59.webp";
...
const recentActivity = [
  ...
  {
    time: "12m ago",
    event: "Telegram alert sent to 4.8K users",
    type: "telegram",
  },
      ...
      <div className="relative rounded-xl overflow-hidden p-6 lg:p-8 mb-2">
        ...
        <div className="relative">
          ...
          <p className="text-gray-400 text-sm">
            Real-time overview of all NeuraWealth OS modules
          </p>
