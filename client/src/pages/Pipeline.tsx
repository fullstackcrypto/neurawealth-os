...
const PIPELINE_1: PipelineNode[] = [
  ...
  {
    id: "ta-engine",
    label: "Technical Analysis Engine",
    icon: Cpu,
    color: "#00ff88",
...
const PIPELINE_2: PipelineNode[] = [
  {
    ...
    icon: Database,
    color: "#00d4ff",
    lastProcessed: "1m ago",
    status: "active",
  },
  {
    id: "claim-scorer",
    label: "AI Claim Scorer",
    icon: Cpu,
    color: "#ffb800",
    lastProcessed: "2m ago",
    status: "active",
  },
  {
    id: "lead-db",
    ...
    icon: Database,
    color: "#00d4ff",
    lastProcessed: "3m ago",
    status: "active",
  },
  {
    id: "marketplace",
    label: "Gated Marketplace",
    icon: ShoppingBag,
    color: "#a855f7",
...
function PipelineNodeCard({
  ...
  return (
    <div className="flex items-center">
      ...
      >
        <div
          className={`glass-card rounded-xl p-4 w-36 sm:w-44 ${node.status === "active" ? "animate-pulse-glow" : ""}`}
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <div
              className={`w-2 h-2 rounded-full ${node.status === "active" ? "animate-pulse" : ""}`}
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">
          Visual data flow from market data ingestion to revenue generation
        </p>
      </div>
      ...
      >
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-[#00ff88] text-xs font-mono ml-auto">
            ACTIVE
          </span>
        </div>
        ...
        <div className="mt-4 p-3 rounded-lg bg-[#00ff88]/5 border border-[#00ff88]/10">
          <p className="text-gray-400 text-xs">
            <span className="text-[#00ff88] font-mono">Flow:</span> Market data
            from CoinGecko API feeds into the Technical Analysis Engine (RSI,
            EMA, MACD calculations), then AI Scoring assigns confidence levels,
            Signal Generation creates BUY/SELL/HOLD recommendations, which are
            delivered via Telegram Bot to 4,800+ subscribers, generating
      ...
      >
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-[#ffb800] text-xs font-mono ml-auto">
            PROCESSING
          </span>
        </div>
        <div className="overflow-x-auto pb-2">
        ...
        <div className="mt-4 p-3 rounded-lg bg-[#ffb800]/5 border border-[#ffb800]/10">
          <p className="text-gray-400 text-xs">
            <span className="text-[#ffb800] font-mono">Flow:</span> Government
            geological data is processed by the AI Claim Scorer, which evaluates
            mineral probability, terrain analysis, and historical yield data.
            Scored leads are stored in the Lead Database and made available
            through the Gated Marketplace for Pro and Enterprise subscribers.
          </p>
        </div>
      </motion.div>
