  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        <span className="px-2 py-0.5 rounded bg-[#00d4ff]/10 text-[#00d4ff] text-xs font-mono">
          {service.category}
        </span>
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        {service.features.map(f => (
          <span
            key={f}
            className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-white/5 text-gray-300 text-xs"
          >
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">
          Subscribe to AI-powered APIs and services for crypto analysis and
          automation
        </p>
      </div>
