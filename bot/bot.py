...
tracking, price alerts, and automated delivery.
...
from signals import format_signal, generate_signals, get_top_signals
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        ...
        "  /signals — Top 3 BUY signals with confidence\n"
...
async def cmd_trending(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    for i, entry in enumerate(coins, 1):
        ...
        # Try to get USD price from nested data
...
async def cmd_subscribe(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Show subscription tiers and payment links."""
    if update.effective_message is None or update.effective_user is None:
        return
    ...
    text = (
        ...
        "  • /alert — Price alerts (60s checks)\n"
        "  • /report — Daily market reports\n"
